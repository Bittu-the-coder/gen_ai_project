...
import { Mic, ArrowLeft, MapPin, Star, Heart, Share2, Award, Calendar, Users } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary">{artisan.yearsExperience}</div>
                  <div className="text-sm text-muted-foreground">{t.yearsExperience}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary">{artisan.followers}</div>
                ...
                <div className="text-center">
                  <div className="flex items-center justify-center gap-1">
                    ...
                    <span className="text-2xl font-bold text-primary">{artisan.rating}</span>
                  </div>
        ...
        <Tabs defaultValue="about" className="space-y-8">
          ...
          <TabsContent value="about" className="space-y-8">
              ...
              <div className="lg:col-span-2">
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">{artisan.story}</p>
                    <p className="text-muted-foreground leading-relaxed">{artisan.fullStory}</p>
                  </CardContent>
                </Card>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium">{artisan.memberSince}</span>
                      </div>
                      <div className="flex items-center justify-between">
            ...
            {/* Featured Products */}
            <div>
              <h3 className="text-xl font-semibold mb-6">{t.featuredProducts}</h3>
