...
export const AppRoutes: React.FC<AppRoutesProps> = ({ language = 'english' }) => {
  return (
    <Routes>
      {/* Public Routes */}
      ...
      <Route 
        path="/dashboard" 
        element={
          <ProtectedRoute requireAuth={true} requireArtisan={true} language={language}>
            <Dashboard />
          </ProtectedRoute>
        } 
      />
...
export const routeConfig = {
  ...
  artisan: [
    { path: '/dashboard', name: 'Dashboard', component: 'Dashboard', requireAuth: true, requireArtisan: true },
    { path: '/upload', name: 'Upload Product', component: 'Upload', requireAuth: true, requireArtisan: true }
  ]
};
...
export const routeMetadata = {
  '/': {
    ...
    keywords: 'artisan marketplace, voice to shop, AI powered, local artisans, handcrafted products'
  },
  '/marketplace': {
    title: 'Marketplace - Discover Authentic Handcrafted Products',
    description: 'Browse authentic handcrafted products with their voice stories from local artisans around the world.',
    keywords: 'handcrafted products, artisan marketplace, authentic crafts, voice stories'
  },
  '/dashboard': {
  ...
  '/upload': {
    ...
    description: 'Upload a voice note and let AI create your product story in 60 seconds.',
